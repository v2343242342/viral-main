...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!$res['success']) {
        ...
        header("Location: https://viralbreath.agency/paid-social-media-manager/");
    } else {
        // If CAPTCHA is successfully completed...

        // Paste mail function or whatever else you want to happen here!
        header("Location: https://viralbreath.agency/thank-you");
    }
} else { ?>
